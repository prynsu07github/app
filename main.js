...
const getReportBtn =document.querySelector(".get-report")
getReportBtn.addEventListener("click" , ()=>{
 ...
 async function getWeatherData(city){
    try{
      ...
      document.querySelector(".icon").innerHTML=`<img src="http://openweathermap.org/img/wn/${weatherIcon}.png" alt="sunny">`
